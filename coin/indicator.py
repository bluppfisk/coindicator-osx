...
class Indicator(object):
    ...
    def __init__(self, counter, config, settings=None):
        ...
        # self.indicator = Gtk.Widget()
        # self.indicator.set_from_file(icon)
        self.indicator = NSStatusBar.systemStatusBar().statusItemWithLength_(-1) #NSVariableStatusItemLength
        self.indicator.setImage_(None)
    ...
    def start(self):
        # self.indicator.connect('activate', self._menu)
        # self.indicator.setMenu_(self._menu)
